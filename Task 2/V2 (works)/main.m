...
M2 = M_IsentropicRelation(pe, pa, Me, gamma);
nu_e = Nu_calculator(Me, gamma);
nu_2 = Nu_calculator(M2, gamma);
plus = true;
...
%NS_x, NS_y, NS_phi, NS_nu, NS_M, NS_mu, NS_alpha_minus, NS_alpha_plus = MidLine_Region(S_Waves1T);
